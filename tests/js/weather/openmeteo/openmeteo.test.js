...
describe('openmeteo.js', () => {
    ...
    test('fetchWeatherData makes a GET request to the correct URL', async () => {
        ...
        const expectedUrl = `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&minutely_15=temperature_2m,apparent_temperature,precipitation&models=best_match&forecast_days=1&forecast_minutely_15=${4 * forecastHours}&timezone=auto`;
